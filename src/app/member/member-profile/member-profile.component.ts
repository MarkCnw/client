import { AfterViewChecked, Component, computed, ElementRef, inject, NgModule, OnDestroy, OnInit, Signal, ViewChild } from '@angular/core'
...
export class MemberProfileComponent implements OnInit, AfterViewChecked, OnDestroy {
  ...
  async toggleChat() {
    ...
    this.numberOfMessages = this.messageService.paginator().items.length
  }
  ngOnDestroy(): void {
    if (this.subscription)
      this.subscription.unsubscribe()
